...
public class SubsystemComponents {
	...
	public static interface Lift {
		public static final VictorSP MOTOR_A = new VictorSP(RobotMap.PWM.LIFT_MOTOR_A);
		public static final VictorSP MOTOR_B = new VictorSP(RobotMap.PWM.LIFT_MOTOR_B);
		public static final DigitalInput HALL_EFFECTS = new DigitalInput(RobotMap.DIO.LIFT_HALL_EFFECTS);
