...
public class Robot extends TimedRobot {
	...
	public void robotInit() {
		...
		SubsystemComponents.Drivetrain.LEFT_ENCODER
				.setDistancePerPulse(SubsystemConstants.Drivetrain.DISTANCE_PER_PULSE.get());
		SubsystemComponents.Drivetrain.RIGHT_ENCODER
				.setDistancePerPulse(SubsystemConstants.Drivetrain.DISTANCE_PER_PULSE.get());
	}
