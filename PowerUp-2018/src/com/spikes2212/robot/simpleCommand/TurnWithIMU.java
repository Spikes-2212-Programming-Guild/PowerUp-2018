...
public class TurnWithIMU extends DriveArcade {
	...
	public static final Supplier<Double> ROTATE_SPEED = ConstantHandler.addConstantDouble("imu rotate speed", 0.4);
	public static final Supplier<Double> ROTATE_TOLERANCE = ConstantHandler.addConstantDouble("imu rotate tolerance",
			3);
