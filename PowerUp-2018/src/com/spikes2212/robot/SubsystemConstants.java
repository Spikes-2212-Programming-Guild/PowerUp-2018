...
public class SubsystemConstants {
	...
	public static interface Roller {
		public static final Supplier<Double> IN_SPEED = ConstantHandler.addConstantDouble("Roller In Speed", 0.7);
		public static final Supplier<Double> OUT_SPEED = ConstantHandler.addConstantDouble("Roller Out Speed", -0.6);
	}
